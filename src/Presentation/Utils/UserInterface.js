...
export default class UserInterface extends EventEmitter
{
    ...
    createShowDetailsButton(serial)
    {
        ...
        detailedScreenLink.onclick = () => {window.open(`http://ec2-34-244-143-219.eu-west-1.compute.amazonaws.com:8080/dashboards/edit/#96054cad-6e19-2b84-5c3f-b0c5ef803ae1?viewstate={%22selected_unit%22:%22${serial}%22}`)}
